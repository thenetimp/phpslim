...
use \Exception;
use \PDO;
use Hackerspace\User as ChildUser;
use Hackerspace\UserQuery as ChildUserQuery;
use Hackerspace\Map\UserTableMap;
...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Hackerspace\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of Hackerspace\Base\User object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Hackerspace\User The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Hackerspace\\User'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Hackerspace\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Hackerspace\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Hackerspace\User Clone of current object.
     * @throws PropelException
     */
