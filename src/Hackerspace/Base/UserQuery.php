...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Hackerspace\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Hackerspace\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, email_address, real_email_address, password_hash, first_name, last_name, alias, terms_agree, newsletter_subscribe, failed_login_attempts, last_login_attempt, created_at, updated_at FROM users WHERE id = :p0';
        try {
