...
namespace Hackerspace\Base;

use \DateTime;
use \Exception;
use \PDO;
use Hackerspace\UserGroup as ChildUserGroup;
use Hackerspace\UserGroupQuery as ChildUserGroupQuery;
use Hackerspace\Map\UserGroupTableMap;
...
/**
 * Base class that represents a row from the 'user_groups' table.
 *
 *
 *
* @package    propel.generator.Hackerspace.Base
*/
abstract class UserGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Hackerspace\\Map\\UserGroupTableMap';
    ...
    /**
     * Initializes internal state of Hackerspace\Base\UserGroup object.
     */
     ...
     * @return $this|\Hackerspace\UserGroup The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Hackerspace\\UserGroup'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO user_groups (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Hackerspace\UserGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Hackerspace\UserGroup The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserGroupTableMap::COL_NAME)) {
            $criteria->add(UserGroupTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(UserGroupTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Hackerspace\UserGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Hackerspace\UserGroup Clone of current object.
     * @throws PropelException
     */
