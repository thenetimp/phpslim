...
use Hackerspace\UserGroup;
use Hackerspace\UserGroupQuery;
...
class UserGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Hackerspace.Map.UserGroupTableMap';
     ...
     */
    const OM_CLASS = '\\Hackerspace\\UserGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Hackerspace.UserGroup';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Hackerspace\\UserGroup');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Hackerspace\UserGroup) { // it's a model object
