...
use \Exception;
use \PDO;
use LeadCollector\Client as ChildClient;
use LeadCollector\ClientQuery as ChildClientQuery;
use LeadCollector\Map\ClientTableMap;
...
abstract class Client implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\LeadCollector\\Map\\ClientTableMap';
    ...
    /**
     * Initializes internal state of LeadCollector\Base\Client object.
     */
     ...
     * @return $this|\LeadCollector\Client The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ClientTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ClientTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 3; // 3 = ClientTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\LeadCollector\\Client'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\LeadCollector\Client
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\LeadCollector\Client The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LeadCollector\Client (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LeadCollector\Client Clone of current object.
     * @throws PropelException
     */
