...
abstract class UserGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\LeadCollector\\Map\\UserGroupTableMap';
    ...
    /**
     * Initializes internal state of LeadCollector\Base\UserGroup object.
     */
     ...
     * @return $this|\LeadCollector\UserGroup The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\LeadCollector\\UserGroup'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\LeadCollector\UserGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\LeadCollector\UserGroup The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LeadCollector\UserGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LeadCollector\UserGroup Clone of current object.
     * @throws PropelException
     */
