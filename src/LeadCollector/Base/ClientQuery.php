...
abstract class ClientQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \LeadCollector\Base\ClientQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\LeadCollector\\Client', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, created_at, updated_at FROM clients WHERE id = :p0';
        try {
