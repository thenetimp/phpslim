...
use LeadCollector\UserGroupUser;
use LeadCollector\UserGroupUserQuery;
...
/**
 * This class defines the structure of the 'user_groups_user' table.
 *
 *
 *
...
class UserGroupUserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'LeadCollector.Map.UserGroupUserTableMap';
     ...
     */
    const TABLE_NAME = 'user_groups_user';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\LeadCollector\\UserGroupUser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'LeadCollector.UserGroupUser';
     ...
     */
    const COL_ID = 'user_groups_user.id';

    /**
     * the column name for the userId field
     */
    const COL_USERID = 'user_groups_user.userId';

    /**
     * the column name for the userGroupId field
     */
    const COL_USERGROUPID = 'user_groups_user.userGroupId';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'user_groups_user.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'user_groups_user.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Userid', 'Usergroupid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'userid', 'usergroupid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(UserGroupUserTableMap::COL_ID, UserGroupUserTableMap::COL_USERID, UserGroupUserTableMap::COL_USERGROUPID, UserGroupUserTableMap::COL_CREATED_AT, UserGroupUserTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'userId', 'userGroupId', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Userid' => 1, 'Usergroupid' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userid' => 1, 'usergroupid' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(UserGroupUserTableMap::COL_ID => 0, UserGroupUserTableMap::COL_USERID => 1, UserGroupUserTableMap::COL_USERGROUPID => 2, UserGroupUserTableMap::COL_CREATED_AT => 3, UserGroupUserTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'userId' => 1, 'userGroupId' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        // attributes
        $this->setName('user_groups_user');
        $this->setPhpName('UserGroupUser');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\LeadCollector\\UserGroupUser');
        $this->setPackage('LeadCollector');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('userId', 'Userid', 'INTEGER', true, null, null);
        $this->addColumn('userGroupId', 'Usergroupid', 'INTEGER', true, null, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserGroupUserTableMap::COL_USERID);
            $criteria->addSelectColumn(UserGroupUserTableMap::COL_USERGROUPID);
            $criteria->addSelectColumn(UserGroupUserTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(UserGroupUserTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \LeadCollector\UserGroupUser) { // it's a model object
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                UserGroupUserTableMap::removeInstanceFromPool($singleval);
            }
        }
