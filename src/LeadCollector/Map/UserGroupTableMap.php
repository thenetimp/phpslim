...
use LeadCollector\UserGroup;
use LeadCollector\UserGroupQuery;
...
/**
 * This class defines the structure of the 'user_groups' table.
 *
 *
 *
...
class UserGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'LeadCollector.Map.UserGroupTableMap';
     ...
     */
    const OM_CLASS = '\\LeadCollector\\UserGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'LeadCollector.UserGroup';
     ...
     */
    const COL_ID = 'user_groups.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'user_groups.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'user_groups.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'user_groups.updated_at';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UserGroupTableMap::COL_ID, UserGroupTableMap::COL_NAME, UserGroupTableMap::COL_CREATED_AT, UserGroupTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UserGroupTableMap::COL_ID => 0, UserGroupTableMap::COL_NAME => 1, UserGroupTableMap::COL_CREATED_AT => 2, UserGroupTableMap::COL_UPDATED_AT => 3, ),
    ...
    {
        // attributes
        $this->setName('user_groups');
        $this->setPhpName('UserGroup');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\LeadCollector\\UserGroup');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \LeadCollector\UserGroup) { // it's a model object
