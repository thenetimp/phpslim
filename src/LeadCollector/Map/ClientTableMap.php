...
use LeadCollector\Client;
use LeadCollector\ClientQuery;
...
class ClientTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'LeadCollector.Map.ClientTableMap';
     ...
     */
    const OM_CLASS = '\\LeadCollector\\Client';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'LeadCollector.Client';
     ...
     */
    const COL_UPDATED_AT = 'clients.updated_at';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ClientTableMap::COL_ID, ClientTableMap::COL_CREATED_AT, ClientTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ClientTableMap::COL_ID => 0, ClientTableMap::COL_CREATED_AT => 1, ClientTableMap::COL_UPDATED_AT => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\LeadCollector\\Client');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \LeadCollector\Client) { // it's a model object
